...
public class AuthFlowIntegrationTest {
        ...
        public void testFullAuthFlow() throws Exception {
                ...
                String newAccessToken = com.jayway.jsonpath.JsonPath.read(refreshResponseBody, "$.data.accessToken");
                String newRefreshToken = com.jayway.jsonpath.JsonPath.read(refreshResponseBody, "$.data.refreshToken");
                ...
                String reLoginAccessToken = com.jayway.jsonpath.JsonPath.read(reLoginBody, "$.data.accessToken");
