...
public enum ErrorCode {
    ...
    PARTNERSHIP_REQUEST_AWAITING_VERIFICATION("PARTNER-007",
            ...
            HttpStatus.BAD_REQUEST),
    PARTNERSHIP_POLICY_ACCEPTANCE_REQUIRED("PARTNER-008", "Bạn phải đồng ý với chính sách trước khi gửi yêu cầu hợp tác.",
            HttpStatus.UNPROCESSABLE_CONTENT),
    ...
    BOOTH_TEMPLATE_PANORAMA_REQUIRED("BOOTH-043", "Mẫu gian hàng phải có ít nhất một panorama.", HttpStatus.BAD_REQUEST),
    BOOTH_TEMPLATE_PANORAMA_INVALID("BOOTH-044", "Dữ liệu panorama của mẫu gian hàng không hợp lệ.", HttpStatus.BAD_REQUEST),
    ...
    DESIGN_DRAFT_REQUEST_INVALID("DESIGN-019", "Yêu cầu cập nhật bản thiết kế nháp không hợp lệ.",
            HttpStatus.BAD_REQUEST),
    DESIGN_DRAFT_GRAPH_INVALID("DESIGN-020", "Bản thiết kế nháp không thuộc yêu cầu thiết kế này.", HttpStatus.BAD_REQUEST),
    ...
    DESIGN_DRAFT_HOTSPOT_REFERENCE_INVALID("DESIGN-025", "Tham chiếu của hotspot trong bản thiết kế nháp không hợp lệ.",
            HttpStatus.BAD_REQUEST),
    DESIGN_DRAFT_PRODUCT_REFERENCE_INVALID("DESIGN-026", "Sản phẩm được tham chiếu trong bản thiết kế nháp không hợp lệ.",
            HttpStatus.BAD_REQUEST),
    DESIGN_DRAFT_MEDIA_REFERENCE_INVALID("DESIGN-027", "Tệp phương tiện được tham chiếu trong bản thiết kế nháp không hợp lệ.",
            HttpStatus.BAD_REQUEST),
    ...
    EXHIBITION_DURATION_EXCEEDED("EXHIBITION-021", "Thời lượng triển lãm vượt quá giới hạn cho phép.",
            HttpStatus.UNPROCESSABLE_CONTENT),
    EXHIBITION_START_LEAD_TIME_NOT_MET("EXHIBITION-022", "Ngày bắt đầu triển lãm không đáp ứng thời gian chuẩn bị tối thiểu.",
            HttpStatus.UNPROCESSABLE_CONTENT),
    ...
    EXHIBITION_PACKAGE_INACTIVE("EXHIBITION-029", "Gói triển lãm không ở trạng thái hoạt động.",
            HttpStatus.UNPROCESSABLE_CONTENT),
    EXHIBITION_PACKAGE_TEMPLATE_INACTIVE("EXHIBITION-030", "Mẫu gói dịch vụ của triển lãm không ở trạng thái hoạt động.",
            HttpStatus.UNPROCESSABLE_CONTENT),
    ...
    REGISTRATION_ALREADY_PAID("REGISTRATION-005",
            ...
            HttpStatus.BAD_REQUEST),
    REGISTRATION_COMPANY_MISSING("REGISTRATION-006", "Lượt đăng ký thiếu thông tin doanh nghiệp.",
            HttpStatus.UNPROCESSABLE_CONTENT),
