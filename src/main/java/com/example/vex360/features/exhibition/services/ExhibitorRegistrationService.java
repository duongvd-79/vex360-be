...
public interface ExhibitorRegistrationService {
    ...
    PageResponse<ExhibitorRegistrationResponseDTO> getRegistrationsForOrganizer(
            User organizer, UUID exhibitionUuid, ExhibitorRegistrationStatus status, String keyword, Pageable pageable);

    ExhibitorRegistrationResponseDTO approveRegistration(User organizer, UUID registrationUuid);

    ExhibitorRegistrationResponseDTO rejectRegistration(User organizer, UUID registrationUuid, String rejectedReason);
}
